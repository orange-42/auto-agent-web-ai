...
class PlannerAgent extends base_agent_1.BaseAgent {
    execute(input, lessons, onThought) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a;
            const hasPrefetchedComponentContext = Boolean((_a = input.targetComponentContext) === null || _a === void 0 ? void 0 : _a.trim());
...
${input.projectTree || "项目目录树暂未预取。如仍缺少结构信息，请优先调用 filesystem:directory_tree 或 filesystem:list_directory，禁止盲目重复搜索。"}
- 目标组件快照 (Hotspots):
...
USER CMD: ${input.query}`;
            ...
            ], onThought, toolPattern, hasPrefetchedComponentContext ? 4 : 10);
        });
    }
}
