...
exports.MemoryVault = void 0;
const fs = __importStar(require("fs"));
/**
 * MemoryVault: 处理 Episodic (事件) 和 Semantic (策略) 记忆的持久化与加载
 */
class MemoryVault {
    constructor(episodicFile, semanticFile) {
    ...
    getEpisodic() { return this.episodicMemory; }
    getSemantic() { return this.semanticMemory; }
