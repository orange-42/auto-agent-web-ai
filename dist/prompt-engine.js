...
exports.PromptEngine = exports.DISPLAY_PHASES = void 0;
exports.DISPLAY_PHASES = [
 ...
 */
class PromptEngine {
    buildSystemPrompt(toolGuide, prefetchedSources, taskListSnapshot, phaseKnowledgeSummary, circuitBreakerWarnings, adaptiveGuidance, episodicMemory, semanticMemory) {
...
${prefetchedSources.map((s, i) => {
            var _a;
            return `### [资料 ${i + 1}] URL: ${s.url}
状态: ${s.status === 'success' ? '加载成功 (仅展示摘要)' : '加载受限'}
内容摘要:
${((_a = s.content) === null || _a === void 0 ? void 0 : _a.substring(0, 1000)) || "(无内容)"} ... [内容已截断，请按需调用工具查询全文]
`;
        }).join("\n---\n")}` : ""}
...
[DONE] 标记表示任务终结。`;
    ...
    buildToolUsageGuide(allMcpTools) {
